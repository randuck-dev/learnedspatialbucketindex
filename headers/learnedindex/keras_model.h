...
class KerasLayer {
  public:
    ...
    virtual Tensor getBiases() const = 0;
...
class KerasLayerActivation : public KerasLayer {
  public:
    ...
    virtual Tensor getWeights() const;
    virtual Tensor getBiases() const;
...
class KerasModel {
  public:
    ...
    virtual std::vector<KerasLayer*>  getLayers() const;
  private:
